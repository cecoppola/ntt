...
static const struct comm_ops local_ops = { l_rank, l_size, l_alltoall, l_wait, l_barrier, l_allreduce_modq, l_allreduce_max, l_destroy, 0, 0, l_allgather, l_allgather_host };
