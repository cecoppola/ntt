...
| 4 × 10¹⁰, planes on (the final default) | job 20903: 81.7 s; BATCH7 | identical, VERIFY OK (§4, §6b) |
...
### 6b. The final build (planes by the size rule, `MEM_ALLOC=hipmalloc`; BATCH7)
