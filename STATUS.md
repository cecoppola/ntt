...
| make check        | 17/17 host PASS; non-vacuity gate 12/12 NON-VACUOUS (+test-modops) |
...
- ntt_mul_init_impl(int max_log_n) — allocates NttMulState, precomputes n_inv + twiddles
  (NOTE: does NOT enable peer access — only main.hip/crt_ntt does; a 4-APU arith gap, see DEPLOYMENT_DIAGNOSTIC P6)
