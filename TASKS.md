...
| 1b | **One-node check of the grid steps** the model predicts (RESULTS §80), including the possible one at 1.42–1.44 × 10¹¹ (2³⁰) | the 4.4 × 10¹³ target was chosen by a modelled step position; two or three 20-min jobs |
